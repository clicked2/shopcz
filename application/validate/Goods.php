...
class Goods extends Validate
{
    ...
    //场景验证设置
    protected $scene = [
        'save' => ['market_price', 'shop_price', 'goods_name', 'is_on_sale', 'goods_desc', 'brand_id'],
        'update' => ['market_price', 'shop_price', 'goods_name', 'is_on_sale', 'goods_desc', 'brand_id'],
        'read' => ['ios', 'gn', 'fa', 'ta', 'fp', 'sp', 'bd'],
        'edit' => [''],
        'delete' => [''],
        'add' => [''],
        'index' => [''],
